...
const SLUG = "proyecto-edad-de-plata";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "El proyecto de digitalización y catalogación de la Edad de Plata española.",
  };
}

export default async function ProyectoEdadDePlataPage() {
  const page = await getPage(SLUG);
