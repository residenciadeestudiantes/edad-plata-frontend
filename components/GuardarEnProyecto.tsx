...
// Botón "Guardar en proyecto": permite a un usuario registrado añadir este
// artículo a una de sus carpetas privadas (backend/src/api/proyecto). Si no
// hay sesión, invita a iniciarla en /cuenta en vez de mostrar el control.
  ...
  if (!conSesion) {
    return (
      <Link href="/cuenta" className="text-sm font-bold text-teja hover:underline dark:text-teja-claro">
        Inicia sesión para guardar este artículo
      </Link>
    );
  }
